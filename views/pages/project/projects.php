        ...
        <section class="p-[4%] flex flex-col gap-10">
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="max-w-sm p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 group cursor-pointer">
                    ...
                    <span class="inline-block px-3 py-1 mb-6 text-sm font-medium text-emerald-600 bg-emerald-50 rounded-full">
                        active
                    </span>
                    ...
                    <a class="w-full py-3 flex items-center justify-center gap-2 border border-gray-200 rounded-xl text-gray-900 font-semibold bg-gray-50/50 group-hover:bg-indigo-600 group-hover:text-white group-hover:border-indigo-600 transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
