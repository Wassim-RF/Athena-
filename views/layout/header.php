<header class="w-full h-12 bg-white border-b border-gray-100 shadow-[4px_0_24px_rgba(0,0,0,0.05)] sticky top-0 right-0 flex items-center justify-between p-[1%] pt-[2%] pb-[2%]">
    <div class="group flex items-center text-gray-900 bg-gray-100 rounded-lg border-none p-[0.4%] gap-5 w-[30%]">
    ...
    <div class="flex items-center gap-6 ml-4">
        ...
        <div class="flex items-center gap-3 cursor-pointer border-l border-gray-200 pl-5">
            ...
            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-linear-to-tr from-purple-600 to-indigo-600 text-white font-medium text-lg ring-2 ring-white shadow-sm">
